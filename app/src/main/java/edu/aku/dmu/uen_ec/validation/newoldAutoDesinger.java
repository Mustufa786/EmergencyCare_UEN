...
public abstract class newoldAutoDesinger {
...
//        if (rdGrp.getCheckedRadioButtonId() == ) {
//            FancyToast.makeText(context, "ERROR(empty): " + msg, FancyToast.LENGTH_SHORT, FancyToast.ERROR, false).show();
...
//        } else {
    ...
    public static boolean EmptyRadioButtonother(Context context, RadioGroup rdGrp, RadioButton rdBtn, EditText txt, String msg) {
